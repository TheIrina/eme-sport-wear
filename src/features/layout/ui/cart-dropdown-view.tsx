...
import type { CartDropdownViewProps } from "../types/cart-dropdown.types"

/**
 * CartDropdownView — "The Face" of the CartDropdown feature.
 *
 * Purely presentational. Renders the popover with cart items,
 * subtotal, and navigation. Zero business logic.
 */
export const CartDropdownView = ({
  cartDropdownOpen,
  totalItems,
  subtotal,
  openAndCancel,
